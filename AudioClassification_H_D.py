...
# -------------------------------
# 3. Define label extraction and filtering (only for D and H)
# -------------------------------
# Now we map:
#   'D' (degraded)   to 0.0,
#   'H' (healthy)    to 1.0.
label_mapping = {'D': 0.0, 'H': 1.0}
...
def prepare_dataset(ds):
    ...
    # Filter out examples with label -1 (i.e. those not starting with 'D' or 'H')
...
# -------------------------------
# 5. Build a Keras regression model for binary prediction
# -------------------------------
...
# -------------------------------
# 6. Train the model with validation metrics printed
# -------------------------------
